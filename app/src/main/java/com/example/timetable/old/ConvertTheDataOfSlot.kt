...
class ConvertTheDataOfSlot(semWeek: Week) {
    var tut = semWeek.tuesday //arrayListOf("TEE1","A1","B1","C1","D1","","E2","A2","TBB2","C2","TDD2","","","","","","","","SE1","","G2","","","")
    var wed = semWeek.wednesday//arrayListOf("TG1","D1","F1","E1","B1","","E2","D2","F2","B2","TCC2","","","","","","","","SC1","","","","","")
    var thu = semWeek.thursday//arrayListOf("TF1","TC1","TD1","TA1","TFF1","","B2","F2","TD2","TA2","TG2","","","","","","","","","","","","","")
    var fri = semWeek.friday//arrayListOf("TCC1","TB1","TAA1","TE1","F1","","C2","TB2","TAA2","TE2","TF2","","","","G1","","","","","","G2","SD1","","")
    var sat = semWeek.saturday//arrayListOf("TDD1","C1","A1","TBB1","E1","","D2","TC2","A2","SF1","TEE2","","","","","G1","","","","","","","","")
    var tutL = semWeek.tuesdayLab//arrayListOf("L1", "L2" ,"L3", "L4" ,"L5" ,"L6" ,"L31","L32","L33","L34","L35","L36")
    var wedL = semWeek.wednesdayLab//arrayListOf("L7","L8","L9","L10","L11","L12","L37","L38","L39","L40","L41","L42")
    var thuL = semWeek.thursdayLab//arrayListOf("L13","L14","L15","L16","L17","L18","L43","L44","L45","L46","L47","L48")
    var friL = semWeek.fridayLab//arrayListOf("L19","L20","L21","L22","L23","L24","L49","L50","L51","L52","L53","L54")
    var satL = semWeek.saturdayLab//arrayListOf("L25","L26","L27","L28","L29","L30","L55","L56","L57","L58","L59","L60")
